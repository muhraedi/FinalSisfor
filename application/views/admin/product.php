                                ...
                                <tbody>
                                    <?php foreach ($query as $product): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo $product->jenis_paket ?>
                                            </td>
                                            <td>
                                                <?php echo $product->nama_paket ?>
                                            </td>
                                            <td>
                                                <?php echo $product->fasilitas ?>
                                            </td>
                                            <td>
                                                <?php echo $product->jenis_kerjasama ?>
                                            </td>
                                            <td>
                                                <?php echo $product->harga_per_bulan ?>
                                            </td>
                                            <td>
                                                <?php echo $product->harga_per_tahun ?>
                                            </td>
                                            <td>
                                                <form action="<?php echo base_url('index.php/admin/productTambah') ?>" method="post">
                                            ...
                                            <td>
                                                <form action="<?php echo base_url('index.php/admin/productDelete') ?>" method="post">
                                                    <input type="hidden" name="id" value="<?php echo $product->id ?>">
                                                    <button type="submit" class="btn bg-red waves-effect" onclick="return confirm('Are you sure want to delete?')">
